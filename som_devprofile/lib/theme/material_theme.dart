...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xFF16213e),
      tertiary: Color(0xFF2575fc),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xFF9fa8da),
      onTertiaryContainer: Color(0xFF0f3460),
      ...
      inversePrimary: Color(0xFF8e2de2),
      primaryFixed: Color(0xFFe8eaf6),
      onPrimaryFixed: Color(0xFF1a1a2e),
      primaryFixedDim: Color(0xFFc5cae9),
      onPrimaryFixedVariant: Color(0xFF16213e),
      secondaryFixed: Color(0xFFc5cae9),
      onSecondaryFixed: Color(0xFF1a1a2e),
      secondaryFixedDim: Color(0xFF9fa8da),
      onSecondaryFixedVariant: Color(0xFF16213e),
      tertiaryFixed: Color(0xFF9fa8da),
      onTertiaryFixed: Color(0xFF0f3460),
      tertiaryFixedDim: Color(0xFF7986cb),
      onTertiaryFixedVariant: Color(0xFF1a1a2e),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xFFb4b8ff),
      secondary: Color(0xFF8e2de2),
      onSecondary: Color(0xffffffff),
      ...
      onTertiaryContainer: Color(0xFF9fa8da),
      ...
      inversePrimary: Color(0xFF6a11cb),
      primaryFixed: Color(0xFF8e2de2),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xFF6a11cb),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xFFc5cae9),
      onSecondaryFixed: Color(0xFF1a1a2e),
      secondaryFixedDim: Color(0xFF9fa8da),
      onSecondaryFixedVariant: Color(0xFF16213e),
      tertiaryFixed: Color(0xFF2575fc),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xFF4a00e0),
      onTertiaryFixedVariant: Color(0xffffffff),
